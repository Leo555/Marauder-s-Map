 ...
 */
import { W, S, drawRoom, drawTower, drawStairs, drawCorridor, drawDoor, addLabel, drawBorder, drawCompass, drawPoly, drawCurvedCorridor, drawLRoom, drawHouseCrest, drawHouseGlow } from './svg-draw.js?v=1.16';
import { getLang } from './i18n.js?v=1.16';
